...
export default function BookAccountingPanel({ companyCode, companyName, competence, accessToken }: { companyCode: string; companyName: string; competence: string; accessToken: string }) {
