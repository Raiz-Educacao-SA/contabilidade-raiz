...
export default function Home() {
  ...
  return <div className={`shell ${selectedModule === "book" ? "book-shell" : ""}`}>
    ...
    <main className={`content ${selectedModule === "book" ? "book-content" : ""}`}><header><div><span className="eyebrow">CONTABILIDADE RAIZ</span><h1>{activeModule.title}</h1><p>{activeModule.description}</p></div><div className="user-chip">{session.user.email}</div></header>
