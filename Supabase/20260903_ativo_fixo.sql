...
create table if not exists public.ativo_fixo_bens (
  ...
  valor_custo numeric(18,6) not null,
...
create table if not exists public.ativo_fixo_calculos (
  ...
  base_depreciavel numeric(18,6) not null,
  quota_mensal_contabil numeric(18,6) not null,
  depreciacao_mes_contabil numeric(18,6) not null,
  depreciacao_acumulada_contabil numeric(18,6) not null,
  saldo_contabil numeric(18,6) not null,
  quota_mensal_fiscal numeric(18,6),
  depreciacao_acumulada_fiscal numeric(18,6),
  saldo_fiscal numeric(18,6),
